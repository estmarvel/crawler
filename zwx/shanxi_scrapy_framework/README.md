...
```bash
cd /home/intsig/zwx/shanxi_scrapy_framework
...
LEGACY_PROXY_POOL_PATH=/home/intsig/zwx/shanxi/proxy_pool.py
...
```bash
scrapy crawl shanxi_notice -a crawl_days=1 -a max_pages=3
```
