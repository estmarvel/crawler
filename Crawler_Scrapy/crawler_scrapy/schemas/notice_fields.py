...
4. 爬虫/数据库元数据只保存在 NoticeItem 顶层，导出时统一追加一次，不再
   重复塞入每一种业务 Schema；
5. HTML 原文保存在独立快照中，JSON 只记录路径与 SHA256，不重复内嵌原文；
...
NOTICE_SCHEMA_VERSION: Final[str] = "2026-08-25-v9-procurement"
...
ANNOUNCEMENT_SCHEMAS: Final["OrderedDict[str, tuple[str, ...]]"] = OrderedDict(
    {
        ...
        "采购意向公开": _business_fields(
            "项目性质", "采购单位", "采购项目名称", "采购品目",
            "采购需求概况", "预算金额", "预计采购时间",
            "是否专门面向中小企业采购", "备注", "意向明细",
            "发布日期", "发布网站",
        ),
        "采购公告": _business_fields(
            "项目性质", "项目名称", "项目编号", "采购品目类型",
            "采购品目编码", "所属行业", "采购组织形式", "采购方式",
            "预算金额", "最高限价", "资金来源", "项目实施地点",
            "采购需求", "合同履行期限", "质量要求", "是否接受联合体",
            "是否允许进口产品", "是否专门面向中小企业",
            "供应商资格要求", "政府采购政策资格要求", "特定资格要求",
            "采购文件获取开始时间", "采购文件获取结束时间",
            "采购文件获取地点", "采购文件获取方式", "采购文件售价",
            "响应文件提交截止时间", "响应文件提交地点",
            "响应文件提交方式", "开启时间", "开启地点", "开启方式",
            "公告期限", "代理费支付方式", "代理费收费标准", "代理费金额",
            "采购人名称", "采购人地址", "采购人联系人", "采购人联系方式",
            "采购代理机构", "采购代理机构地址", "采购代理机构联系人",
            "采购代理机构联系方式", "项目联系人", "项目联系电话",
            "采购包/标项明细", "其他补充事宜", "发布日期", "发布网站",
        ),
        "采购结果公告": _business_fields(
            "项目性质", "项目名称", "项目编号", "采购品目类型",
            "所属行业", "采购组织形式", "采购方式",
            "中标/成交供应商名称", "供应商地址", "供应商统一社会信用代码",
            "中标/成交金额", "评审总得分", "联合体成员",
            "供应商明细", "主要标的信息", "废标明细", "评审专家名单",
            "采购人代表", "代理服务收费标准", "代理服务收费金额",
            "公告期限", "采购人名称", "采购人地址", "采购人联系人",
            "采购人联系方式", "采购代理机构", "采购代理机构地址",
            "采购代理机构联系人", "采购代理机构联系方式",
            "项目联系人", "项目联系电话", "其他补充事宜",
            "发布日期", "发布网站",
        ),
        "采购终止公告": _business_fields(
            "项目名称", "项目编号", "采购方式", "终止/废标类型",
            "终止/废标原因", "废标明细", "首次公告日期", "公告期限",
            "采购人名称", "采购人地址", "采购人联系人", "采购人联系方式",
            "采购代理机构", "采购代理机构地址", "采购代理机构联系人",
            "采购代理机构联系方式", "项目联系人", "项目联系电话",
            "其他补充事宜", "发布日期", "发布网站",
        ),
        "采购变更公告": _business_fields(
            "原采购项目编号", "原采购项目名称", "首次公告日期", "变更类型",
            "更正事项", "更正日期", "更正明细", "恢复采购时间",
            "采购人名称", "采购人地址", "采购人联系人", "采购人联系方式",
            "采购代理机构", "采购代理机构地址", "采购代理机构联系人",
            "采购代理机构联系方式", "项目联系人", "项目联系电话",
            "其他补充事宜", "发布日期", "发布网站",
        ),
        "采购合同公告": _business_fields(
            "合同编号", "合同名称", "项目编号", "项目名称", "采购人名称",
            "采购人地址", "采购人联系方式", "供应商名称", "供应商地址",
            "供应商联系方式", "合同金额", "采购方式", "履约期限",
            "履约地点", "履约方式", "合同标的明细", "合同签订日期",
            "合同公告日期", "合同变更原因", "其他补充事宜",
            "发布日期", "发布网站",
        ),
        "采购合同变更公告": _business_fields(
            "原合同编号", "原合同名称", "项目编号", "项目名称", "首次公告日期",
            "变更事项", "变更内容", "变更日期", "项目联系人", "项目联系电话",
            "其他补充事宜", "发布日期", "发布网站",
        ),
        "履约验收公告": _business_fields(
            "合同编号", "合同名称", "项目编号", "项目名称", "采购人名称",
            "采购人地址", "采购人联系方式", "供应商名称", "供应商地址",
            "供应商联系方式", "合同主要内容", "服务内容", "服务要求",
            "服务期限", "服务地点", "验收日期", "验收方式", "验收组成员",
            "服务对象代表", "验收意见", "验收结论", "其他补充事宜",
            "发布日期", "发布网站",
        ),
        "采购意见征询": _business_fields(
            "意见征询类型", "项目名称", "项目编号", "采购人名称",
            "采购需求概况", "拟采购标的明细", "预算金额",
            "采用单一来源原因", "拟定供应商名称", "拟定供应商地址",
            "征求意见范围", "意见递交开始时间", "意见递交截止时间",
            "意见递交方式", "意见接收机构", "联系人", "联系电话",
            "联系邮箱", "财政部门", "财政部门联系人", "财政部门联系方式",
            "公示开始时间", "公示结束时间", "专业人员论证意见",
            "其他补充事宜", "发布日期", "发布网站",
        ),
        "中小企业预留执行情况": _business_fields(
            "部门/单位名称", "统计年度", "面向中小企业采购总金额",
            "面向小微企业采购金额", "小微企业采购占比", "预留项目明细",
            "发布日期", "发布网站",
        ),
        "历史未归类公告": _business_fields(
            "原始公告类型", "项目名称", "项目编号", "采购人名称",
            "采购代理机构", "公告内容", "发布日期", "发布网站",
        ),
    }
)

_PROCUREMENT_TYPE_NAMES: Final[tuple[str, ...]] = (
    "采购意向公开", "采购公告", "采购结果公告", "采购终止公告", "采购变更公告",
    "采购合同公告", "采购合同变更公告", "履约验收公告", "采购意见征询",
    "中小企业预留执行情况", "历史未归类公告",
)
# 保持原 ANNOUNCEMENT_SCHEMAS 仍只代表 XLSX 约定的八类招标公告，避免已有
# 站点和数据库契约被采购字段改变；统一入口 NOTICE_SCHEMAS 同时包含两套业务。
NOTICE_SCHEMAS: Final["OrderedDict[str, tuple[str, ...]]"] = ANNOUNCEMENT_SCHEMAS
PROCUREMENT_SCHEMAS: Final["OrderedDict[str, tuple[str, ...]]"] = OrderedDict(
    (name, NOTICE_SCHEMAS[name]) for name in _PROCUREMENT_TYPE_NAMES
)
ANNOUNCEMENT_SCHEMAS = OrderedDict(
    (name, fields) for name, fields in NOTICE_SCHEMAS.items()
    if name not in PROCUREMENT_SCHEMAS
)
NOTICE_SCHEMAS = OrderedDict((*ANNOUNCEMENT_SCHEMAS.items(), *PROCUREMENT_SCHEMAS.items()))
ANNOUNCEMENT_TYPES: Final[tuple[str, ...]] = tuple(ANNOUNCEMENT_SCHEMAS.keys())
ALL_NOTICE_TYPES: Final[tuple[str, ...]] = tuple(NOTICE_SCHEMAS.keys())
...
NOTICE_TYPE_CODES: Final[dict[str, str]] = {
    ...
    "更正结果公示": "CORRECTION",
    "合同与履约": "CONTRACT",
    "采购意向公开": "PROCUREMENT_INTENTION",
    "采购公告": "PROCUREMENT_NOTICE",
    "采购结果公告": "PROCUREMENT_RESULT",
    "采购终止公告": "PROCUREMENT_TERMINATION",
    "采购变更公告": "PROCUREMENT_CHANGE",
    "采购合同公告": "PROCUREMENT_CONTRACT",
    "采购合同变更公告": "PROCUREMENT_CONTRACT_CHANGE",
    "履约验收公告": "PROCUREMENT_ACCEPTANCE",
    "采购意见征询": "PROCUREMENT_OPINION",
    "中小企业预留执行情况": "SME_RESERVATION",
    "历史未归类公告": "HISTORICAL_UNCLASSIFIED",
}
...
DATETIME_FIELDS: Final[frozenset[str]] = frozenset(
    {
        ...
        "开标时间",
        "采购文件获取开始时间", "采购文件获取结束时间",
        "响应文件提交截止时间", "开启时间", "首次公告日期", "更正日期",
        "恢复采购时间", "合同签订日期", "合同公告日期", "验收日期",
        "变更日期",
        "意见递交开始时间", "意见递交截止时间", "公示开始时间", "公示结束时间",
    }
)
...
DECIMAL_FIELDS: Final[frozenset[str]] = frozenset(
    {
        ...
        "招标金额",
        "合同金额",
        "预算金额", "最高限价", "采购文件售价", "代理费金额",
        "中标/成交金额", "评审总得分", "代理服务收费金额",
        "面向中小企业采购总金额", "面向小微企业采购金额",
    }
)
...
OBJECT_LIST_FIELDS: Final[frozenset[str]] = frozenset(
    {
        "中标候选人明细", "中标结果明细", "意向明细", "采购包/标项明细",
        "供应商明细", "主要标的信息", "废标明细", "更正明细",
        "合同标的明细", "拟采购标的明细", "预留项目明细",
    }
)
BOOLEAN_FIELDS: Final[frozenset[str]] = frozenset({
    "是否已核验", "是否接受联合体", "是否允许进口产品",
    "是否专门面向中小企业", "是否专门面向中小企业采购",
})
...
OPTIONAL_FIELDS: Final[dict[str, frozenset[str]]] = {
    ...
    "采购意向公开": frozenset({"采购品目", "备注"}),
    "采购公告": frozenset({
        "采购品目编码", "所属行业", "采购组织形式", "资金来源",
        "项目实施地点", "质量要求", "是否允许进口产品",
        "是否专门面向中小企业", "采购文件售价", "响应文件提交地点",
        "响应文件提交方式", "开启方式", "代理费支付方式",
        "代理费收费标准", "代理费金额", "采购人联系人",
        "采购代理机构联系人", "其他补充事宜",
    }),
    "采购结果公告": frozenset({
        "采购品目类型", "所属行业", "采购组织形式", "采购方式",
        "供应商统一社会信用代码", "评审总得分", "联合体成员",
        "废标明细", "采购人代表", "代理服务收费标准",
        "代理服务收费金额", "采购人联系人", "采购代理机构联系人",
        "其他补充事宜",
    }),
    "采购终止公告": frozenset({
        "采购方式", "废标明细", "首次公告日期", "公告期限",
        "采购人联系人", "采购代理机构联系人", "其他补充事宜",
    }),
    "采购变更公告": frozenset({
        "恢复采购时间", "采购人联系人", "采购代理机构联系人",
        "其他补充事宜",
    }),
    "采购合同公告": frozenset({
        "采购人联系方式", "供应商联系方式", "履约期限", "履约地点",
        "履约方式", "合同变更原因", "其他补充事宜",
    }),
    "采购合同变更公告": frozenset({"项目编号", "项目名称", "其他补充事宜"}),
    "履约验收公告": frozenset({
        "采购人联系方式", "供应商联系方式", "合同主要内容", "服务内容",
        "服务要求", "服务期限", "服务地点", "验收方式",
        "服务对象代表", "其他补充事宜",
    }),
    "采购意见征询": frozenset({
        "项目编号", "采购需求概况", "拟采购标的明细", "预算金额",
        "采用单一来源原因", "拟定供应商名称", "拟定供应商地址",
        "征求意见范围", "意见递交开始时间", "意见递交截止时间",
        "意见递交方式", "意见接收机构", "联系人", "联系电话",
        "联系邮箱", "财政部门", "财政部门联系人", "财政部门联系方式",
    ...
    "中小企业预留执行情况": frozenset({"面向小微企业采购金额"}),
    "历史未归类公告": frozenset({
        "项目名称", "项目编号", "采购人名称", "采购代理机构",
    }),
}
...
TYPE_OUTPUT_BASENAMES: Final[dict[str, str]] = {
    ...
    "采购变更公告": "05_采购变更公告",
    "采购合同公告": "06_采购合同公告",
    "采购合同变更公告": "06B_采购合同变更公告",
    "履约验收公告": "07_履约验收公告",
    "采购意见征询": "08_采购意见征询",
    "中小企业预留执行情况": "09_中小企业预留执行情况",
    "历史未归类公告": "10_历史未归类公告",
}
...
def get_notice_fields(notice_type: Any) -> tuple[str, ...]:
    ...
    normalized_type = normalize_notice_type(notice_type)
    return NOTICE_SCHEMAS.get(normalized_type, ())
